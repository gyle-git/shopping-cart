...
function removeFromCart(item){
    ...
    //Uklanjanje elemenata iz korpe i oduzimanje totala.

    //Varijable
    let mainEl = item.closest('.cart-single-item');
    ...
    //Resetovanje pocetnih vrednosti za kupovinu.
